...
def check_user(message):
    ...
    ROLE_TEXTS = {
        "Владелец": ("0%", "Человек являеться владельцем базы AK , ему можно доверять 🛡"),
        ...
        "Гл. Заместитель": ("10%", "Человек являеться главным заместителем , риск минимальный ✅"),
        ...
        "Разработчик": ("5%", "Человек являеться разработчиком чата , участие подтверждено ✅")
    }
